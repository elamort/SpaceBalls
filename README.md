...
> **⚠️ Disclaimer:** Take the visuals on this website with a grain of salt. This project has been generated by AI and has not been verified by anyone competent. Test it against your critical thinking. Specifically, the simulation of the analemma is likely very wrong and has not been verified for astronomical accuracy.
...
- **Linear sliders** — Eccentricity, Days per Year, Sun/Moon size, Trail lengths
